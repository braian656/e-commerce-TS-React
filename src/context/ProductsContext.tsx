...
import {InfoApi, ActualProduct,CurrentInfo, ActualUser, UserFromFirebase} from './types/typesApi'
// 
...
const ProductsContext = ({children}: {children: ReactNode})=>{
    ...
    const [userFromDB, setUserFromDB] = useState<UserFromFirebase | null>(null)
  ...
  // se suponene que no funcionaba por que TS esperaba solo un parametro,y paso mucho
    ...
    return(
        ...
        <contextProducts.Provider value={{
          ...
          renderTotalPrice,
          openPagProduct, setOpenPagProduct,
          totalProducts,
          ...
          someErr, setSomeErr,
          userSelectedCategory, setUserSelectedCategory,
          purchasedProducts, setPurchasedProducts,
          picUser, setPicUser,
          selectingPrice,setSelectingPrice,     
          activeItemId, setActiveItemId,
          actualUser,setActualUser,
